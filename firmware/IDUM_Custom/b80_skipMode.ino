//////////////////////////////////////////////////////////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
//////////////////////////////////////////////////////////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
// RETIRED (ID00M) - kept dead-but-present for easy restore.  This was the stock CLOCK SKIP mode in slot 7; that slot now hosts
// SCATTER (b82_scatterMode).  skip() is no longer dispatched from a90_handleOutputs (case 7 calls scatter() instead), and
// setClockSkipMode() below is now unreachable too because its only caller in a60 is guarded by modeOwnsClock(), which always
// returns false (see a91_followUtils).  To restore stock skip: point a90 case 7 back at skip() and make modeOwnsClock() return
// true for index 7.  The original upstream comment for the mode is preserved below.
//
