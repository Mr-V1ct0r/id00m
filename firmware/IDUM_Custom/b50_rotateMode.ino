...
void rotate() {
  ...
  if ((modifyLength2 > 0) && (mode2 == 4)) {
    switch (rotation2) {  //B9 fix: was rotation1 (copy-paste); each channel must switch on its own rotation so split mode / freezeParam can differ per channel
      case 0:
        {
          trig2State = trig3In;
          break;
  ...
  if ((modifyLength3 > 0) && (mode3 == 4)) {
    switch (rotation3) {  //B9 fix: was rotation1
      case 0:
        {
          trig3State = trig2In;
          break;
  ...
  if ((modifyLength4 > 0) && (mode4 == 4)) {
    switch (rotation4) {  //B9 fix: was rotation1
      case 0:
        {
          trig4State = trig4In;
          break;
